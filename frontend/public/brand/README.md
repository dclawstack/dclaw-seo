# DClaw SEO — Brand Assets

The DClaw SEO mark is a **globe inside a magnifying glass** (search the web) — rendered in white inside the brand's purple rounded square (`#7660A8`, 14-unit corner radius). It is a sibling of the other DClaw apps' marks — all share the purple-square shell so they read as one suite, while the inner glyph differentiates the product.
...
| `dclaw-logo-purple.svg` | 252×64 | Wordmark for light surfaces — "DClaw" (ink) + "SEO" (purple) |
| `dclaw-logo-white.svg` | 252×64 | Wordmark for dark surfaces — "DClaw" (white) + "SEO" (light purple) |
...
Heights: **32, 48, 64, 96, 128, 192, 256** — 7 heights × 2 colors × 2 formats = **28 files**. Width is `height × 252/64`.
