...
### Can I run DClaw SEO without Kubernetes?

Yes, for local development:

```bash
cd dclaw-seo/frontend && npm run dev
cd dclaw-seo/backend && uvicorn dclaw_seo.main:app --reload
```
